...
class Config:
    ...
    def __init__(self):
        ...
        self.comet_config = {
            ...
            "project_name": "Conductor-Finetune-Demo",
        ...
        self.pretrained_tokenizer_path = "path/to/your/Conductor-Tokenizer-base"
        self.pretrained_predictor_path = "path/to/your/Conductor-small"
