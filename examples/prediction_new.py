...
# ==================== 主预测函数 ====================
def run_comprehensive_conductor_prediction(stock_code, stock_name, data_dir, pred_days, output_dir, history_years=1):
    """
    运行综合版Conductor模型预测流程
    """
    print(f"\n🎯 开始 {stock_name}({stock_code}) 综合版Conductor模型价格预测")
    print("=" * 60)
    ...
    try:
        ...
        try:
            ...
            print("✅ 模型加载完成 - 使用Conductor-base模型")
        except Exception as e:
            print(f"❌ 模型加载失败: {e}")
        ...
        print(f"\n🎉 {stock_name}({stock_code}) 综合版Conductor模型预测完成!")
...
def main():
    ...
    print("🤖 综合版Conductor模型股票价格预测系统")
    print("=" * 50)
    print("📊 新增功能: 多维度市场因素分析")
    print("🎯 包含: 大盘趋势 + 板块共振 + 宏观政策 + 公司基本面")
    print("🚀 使用模型: Conductor-base (更适合3070Ti显卡)")
    ...
    # 运行综合版Conductor模型预测流程
    run_comprehensive_conductor_prediction(**STOCK_CONFIG)
