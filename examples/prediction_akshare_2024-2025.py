...
if __name__ == "__main__":
    ...
    STOCK_CONFIG = {
        ...
        "output_dir": r"D:\lianghuajiaoyi\Conductor\examples\yuce"  # 输出文件目录
    }

    # 其他股票配置示例：
    # STOCK_CONFIG = {"stock_code": "000001", "stock_name": "平安银行", "data_dir": "./data", "pred_days": 100, "output_dir": r"D:\lianghuajiaoyi\Conductor\examples\yuce"}
    # STOCK_CONFIG = {"stock_code": "600036", "stock_name": "招商银行", "data_dir": "./data", "pred_days": 100, "output_dir": r"D:\lianghuajiaoyi\Conductor\examples\yuce"}
    # STOCK_CONFIG = {"stock_code": "300750", "stock_name": "宁德时代", "data_dir": "./data", "pred_days": 100, "output_dir": r"D:\lianghuajiaoyi\Conductor\examples\yuce"}
    # =========================================================
