...
def save_all_history_stock_data(df, stock_code, save_dir="D:/lianghuajiaoyi/Conductor/examples/data"):
    """
    保存全历史股票数据到指定目录
    """
    if df is not None and not df.empty:
...
def main_all_history(stock_code="002354"):
    ...
    """
    # 设置保存目录
    save_directory = "D:/lianghuajiaoyi/Conductor/examples/data"
