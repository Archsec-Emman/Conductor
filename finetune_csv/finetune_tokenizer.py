...
sys.path.append("../")
from model import ConductorTokenizer
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Conductor Tokenizer Fine-tuning Training')
    ...
    if getattr(config, 'pre_trained_tokenizer', True):
        ...
        tokenizer = ConductorTokenizer.from_pretrained(config.pretrained_tokenizer_path)
    else:
